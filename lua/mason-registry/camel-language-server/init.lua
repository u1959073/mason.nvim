...
local function download_camel()
    std.download_file("https://repo1.maven.org/maven2/com/github/camel-tooling/camel-lsp-server/1.6.0/camel-lsp-server-1.6.0.jar", "camel-lsp-server-1.6.0.jar")
end
...
return Pkg.new {
    ...
    install = function(ctx)
        installer.run_concurrently { download_jdtls, download_lombok, download_camel }
        platform.when {
            unix = function()
